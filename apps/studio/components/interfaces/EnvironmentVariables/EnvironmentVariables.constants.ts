...
import { isPlatformVar, isPlatformVarSecret, PLATFORM_ENV_VARS } from '@supabase-dx/env-vars'
 ...
 */
export const AUTH_CONFIG_ENV_VAR_MAP: Record<string, { envName: string; isSecret: boolean }> =
  Object.fromEntries(
